...
public abstract class Player {
    ...
    Player(final Board board, final Collection<Move> legalMoves, final Collection<Move> opponentMoves) {
        ...
        this.legalMoves = ImmutableList.copyOf(Iterables.concat(legalMoves, calculateLKingCastles(legalMoves, opponentMoves)));
    ...
    protected abstract Collection<Move> calculateLKingCastles(Collection<Move> playerLegals, Collection<Move> opponentLegals);
}
